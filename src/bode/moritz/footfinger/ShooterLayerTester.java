...
public class ShooterLayerTester extends CCColorLayer {
	...
	protected ShooterLayerTester(ccColor4B color,
	...
	public static CCScene scene(NetworkControllerClient networkControllerClient) {
		...
		CCLayer layer = new ShooterLayerTester(ccColor4B.ccc4(255, 255, 255, 255),
