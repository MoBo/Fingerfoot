package bode.moritz.frisboros.sound;
...
import bode.moritz.frisboros.R;
...
public class SoundManager {
	...
	public static void loadSounds(SoundPool.OnLoadCompleteListener listner) {
		...
		mSoundPoolMap.put(R.raw.background_music,
				mSoundPool.load(mContext, R.raw.background_music, 1));
		// Sounds wont be used at the moment but maybe later
		// mSoundPoolMap.put(R.raw.frisbe_slow, mSoundPool.load(mContext,
		// R.raw.frisbe_slow, 1));
		// mSoundPoolMap.put(R.raw.frisbe_fast, mSoundPool.load(mContext,
		// R.raw.frisbe_fast, 1));
		mSoundPoolMap.put(R.raw.swirl,
				mSoundPool.load(mContext, R.raw.swirl, 1));
		mSoundPoolMap.put(R.raw.missed,
				mSoundPool.load(mContext, R.raw.missed, 1));
		mSoundPoolMap.put(R.raw.success,
				mSoundPool.load(mContext, R.raw.success, 1));
	}
